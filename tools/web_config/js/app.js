lynsconfig = angular.module("lynsconfig", ["filters", "controllers", "ngRoute", "ngSanitize"]);

angular.module('lynsconfig')
...
lynsconfig.config(function($httpProvider, $compileProvider) {
